...
if __name__ == "__main__":
    results = analyze_single_stock('AAPL', '2021-01-01', 'plots', '20250310_094854')
    breakout_fractal = results.get('method1').get('plot_path')
    breakout_window = results.get('method2').get('plot_path')

    print(breakout_fractal)
    print(breakout_window)