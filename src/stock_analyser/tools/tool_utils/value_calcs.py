...
def calculate_intrinsic_value_earnings(diluted_eps: float,
                                       growth_rate: float,
                                       discount_rate: float,
                                       terminal_multiple: int,
                                       projection_years: int) -> float:
    """
    ...
    terminal_value = (final_year_eps * terminal_multiple) / ((1 + discount_rate) ** projection_years)
    intrinsic_value += terminal_value
    
    return intrinsic_value


def calculate_margin_of_safety_earnings(diluted_eps: float,
                                        growth_rate: float,
                                        discount_rate: float,
                                        terminal_multiple: int,
    ...
    """
    intrinsic_value = calculate_intrinsic_value_earnings(diluted_eps, growth_rate,
...
def calculate_intrinsic_value_fcf(net_income: int,
                                  depreciation: float,
                                  capex: float,
                                  growth_rate: float,
                                  discount_rate: float,
    ...
    terminal_value = (final_year_fcf * terminal_multiple) / ((1 + discount_rate) ** projection_years)
    intrinsic_value += terminal_value
    
    return intrinsic_value


def calculate_margin_of_safety_fcf(net_income: int,
                                   depreciation: float,
                                   capex: float,
                                   growth_rate: float,
                                   discount_rate: float,
    ...
    - margin_of_safety: Calculated margin of safety as a decimal.
    """
    intrinsic_value = calculate_intrinsic_value_fcf(net_income, depreciation, capex,
...
if __name__ == "__main__":
    ...
    intrinsic_value_earnings = calculate_intrinsic_value_earnings(diluted_eps, growth_rate,
                                                                  discount_rate, terminal_multiple,
                                                                  projection_years)
    mos_earnings = calculate_margin_of_safety_earnings(diluted_eps, growth_rate, discount_rate,
                                                       terminal_multiple, projection_years,
                                                       current_price)
...
# Example test case for FCF-based margin of safety:
    ...
    intrinsic_value_fcf = calculate_intrinsic_value_fcf(net_income, depreciation, capex,
                                                        growth_rate, discount_rate,
                                                        terminal_multiple, projection_years)
    mos_fcf = calculate_margin_of_safety_fcf(net_income, depreciation, capex,
                                             growth_rate, discount_rate,
                                             terminal_multiple, projection_years,
                                             current_price)
