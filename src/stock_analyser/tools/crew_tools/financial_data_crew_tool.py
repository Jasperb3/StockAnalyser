...
class FinancialDataToolInput(BaseModel):
    """Input schema for FinancialDataTool."""
...
class FinancialDataTool(BaseTool):
    ...
    def _run(self, ticker: str) -> str:
        ...
        if not balance_sheet.empty:
            ...
            balance_sheet_data = balance_sheet[most_recent_balance_sheet]
            balance_sheet_data = balance_sheet_data.to_dict()
        ...
        if not cashflow.empty:
            ...
            cash_flow_data = cashflow[most_recent_cashflow]
            cash_flow_data = cash_flow_data.to_dict()
        ...
        if not financials.empty:
            ...
            financials_data = financials[most_recent_financials]
            financials_data = financials_data.to_dict()
...
if __name__ == "__main__":
    ...
    tool_results = financial_data_tool.run(ticker='HMC')
    print(tool_results)